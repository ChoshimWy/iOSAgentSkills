...
Cache directory: ~/.ios-simulator-automation/cache/
...
class ProgressiveCache:
    ...
    def __init__(self, cache_dir: str | None = None, max_age_hours: int = 1):
        ...
        Args:
            cache_dir: Cache directory path (default: ~/.ios-simulator-automation/cache/)
            max_age_hours: Max age for cache entries before expiration (default: 1 hour)
        """
        if cache_dir is None:
            cache_dir = str(Path("~/.ios-simulator-automation/cache").expanduser())
