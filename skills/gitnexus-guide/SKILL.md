...
Provide the GitNexus MCP/tool/resource map and route GitNexus questions to the correct specialized GitNexus skill.
...
```json
{
  "goal": "GitNexus usage question, repo name, tool/resource need, optional schema/query need.",
...
```json
{
  ...
  "recommended_tool": [],
  "known_risks": [],
  "next_action": "gitnexus-cli | gitnexus-exploring | gitnexus-debugging | gitnexus-impact-analysis | gitnexus-refactoring | blocked"
}
```
## Exit Conditions
...
Use first for GitNexus tool/schema/how-to questions, then switch to the task-specific GitNexus skill.
## Token Budget
